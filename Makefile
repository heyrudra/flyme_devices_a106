...
#-----------------------------------------------------------------------------
vendor_saved_apps := Bluetooth BluetoothMidiService HTMLViewer \
	KeyChain PicoTts PrintSpooler UserDictionaryProvider \
	...
	StatementService WallpaperCropper CMSettingsProvider
